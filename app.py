...
# Use environment variable for port (Render defaults to 10000)
PORT = int(os.getenv("PORT", 10000))

# Use Render's persistent disk for data and models
BASE_DIR = os.getenv("RENDER_DISK_PATH", "/var/data")  # Fallback to /var/data if not set
...
API_KEY = os.getenv("API_KEY", "bd6_ai_learn_9821")  # Default for local testing
